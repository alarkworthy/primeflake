...
in
{
  ...
  config = mkIf cfg.enable {
    stylix = {
      enable = true;
      image =
				if config.pluto.system=="Desktop" 
					then "${./bgs/space/purplesky.jpg}"
				else if config.pluto.system=="Laptop" 
					then "${./bgs/space/gcenter_radio.png}" 
				else "${./bgs/space/purplesky.jpg}";
